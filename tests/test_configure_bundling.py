...
from src.bundler_configurator import configure_bundling


class TestConfigureBundling(unittest.TestCase):

    @mock.patch("src.bundler_configurator.update_package_json_scripts")
    @mock.patch("src.bundler_configurator.create_babel_config")
    @mock.patch("src.bundler_configurator.create_webpack_config")
